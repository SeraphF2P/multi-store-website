...
CREATE TABLE `User` (
    ...
    `role` ENUM('guest', 'seller', 'admin') NOT NULL DEFAULT 'guest',
...
-- AddForeignKey
ALTER TABLE `Billboard` ADD CONSTRAINT `Billboard_categoryId_fkey` FOREIGN KEY (`categoryId`) REFERENCES `Category`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
